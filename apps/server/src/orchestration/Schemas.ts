import {
  ...
  ThreadExecutionEnvironmentSetPayload as ContractsThreadExecutionEnvironmentSetPayloadSchema,
...
export const ThreadExecutionEnvironmentSetPayload =
  ContractsThreadExecutionEnvironmentSetPayloadSchema;
